...
public class Repository<T> : IRepository<T> where T : class, IBaseModel
{
    ...
    public async Task<T> GetFirstAsync(Expression<Func<T, bool>> filter, CancellationToken cancellationToken = default,
    ...
    public T GetFirst(Expression<Func<T, bool>> filter, CancellationToken cancellationToken = default,
        params string[] includeProperties)
    {
        cancellationToken.ThrowIfCancellationRequested();
    ...
    public async Task<T> GetFirstNoTrackingAsync(Expression<Func<T, bool>>? filter = null,
    ...
    public async Task<T> GetFirstOrDefaultNoTrackingAsync(Expression<Func<T, bool>>? filter = null,
        CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
    ...
    public async Task<List<T>> GetWithoutTrackingAsync(Expression<Func<T, bool>>? filter = null,
        CancellationToken cancellationToken = default, params string[] includeProperties)
    {
        try
        {
    ...
    public async Task<List<T>> GetByPagesAsync(Expression<Func<T, bool>>? filter, int page, int count,
        CancellationToken cancellationToken, params string[] includeProperties)
    {
        try
        {
    ...
    private async Task IncludeProperties(IQueryable<T> toreTurn, string[] includeProperties,
